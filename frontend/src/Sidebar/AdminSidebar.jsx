...
const menuItems = [
  ...
  { title: "Department Management", to: "/admin/department", icon: <Building2 size={20} /> },
    ...
    <div className="flex flex-col h-full bg-white border-r border-slate-100 shadow-xl shadow-slate-100/50">
      ...
      {!collapsed && (
        <div className="mx-4 mb-6 p-4 bg-indigo-50 rounded-2xl border border-indigo-100">
          <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-2">Admin Panel</p>
          <p className="text-xs text-slate-600 mb-3 leading-relaxed font-medium">Manage organization-wide policies and system settings.</p>
